...
import com.uf.biolens.ui.imaging.IntervalDialog
...
import com.uf.biolens.utility.formatDateTodayTomorrow
...
class ImagingSchedulerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        BioLensRepository.loadDefaultImagingSettings(this)?.let {
